defmodule JumpAgent.Accounts.User do
  ...
  schema "users" do
    ...
    # Optional password fields (for phx.gen.auth compatibility)
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, JumpAgent.Repo)
      |> unique_constraint(:email)
    else
      changeset
    end
  ...
  """
  def valid_password?(%JumpAgent.Accounts.User{hashed_password: hashed_password}, password)
